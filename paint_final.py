...
categories = ["cup" , "fish", "fork", "ladder", "tree", "airplane", "donut", "face", "house", "saw", "tent", "sun", "moon", "dog", "table", "eye", "pear", "sword", "telephone", "tornado", "pool", "stop sign", "oven", "bicycle", "fan", "line", "key", "waterslide", "t-shirt", "purse", "axe", "nose", "belt", "steak", "beach", "mushroom", "shovel", "spoon", "The Eiffel Tower", "zig zag"]
